      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="font-medium text-gray-900">Energy Availability</p>
              <p className="text-sm text-gray-600">Get notified when new energy is available</p>
            </div>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-600">Receive updates on your transactions</p>
            </div>
            <Switch defaultChecked />
          </div>
          <Separator />
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-600">Alert when energy prices change</p>
            </div>
            <Switch />
          </div>
        </CardContent>
